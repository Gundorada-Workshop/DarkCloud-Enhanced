...
namespace Dark_Cloud_Improved_Version
{
    public partial class Form1 : Form
    {
        ...
        //public static Thread customEffectsThread3 = new Thread(new ThreadStart(CustomEffects.HerculesWrathEffect));
        public static Thread customEffectsThread3 = new Thread(new ThreadStart(CustomEffects.Ungaga));
